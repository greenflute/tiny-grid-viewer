...
Inspired by `json-grid-viewer` and `yaml-grid-viewer`, this VS Code extension opens XML, JSON, JSONL, YAML, INI, TOML and tree command output files in a recursive grid-oriented custom editor backed by Vue.
